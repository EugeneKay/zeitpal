...
async function PrivacyPolicyPage() {
  ...
  const sections = t('marketing:privacyPolicyContent.sections', {
    returnObjects: true,
  }) as Array<{ title: string; content: string }>;

  const lastUpdated = t('marketing:privacyPolicyContent.lastUpdated', {
    date: '01.01.2025',
  });
      ...
      <div className="container mx-auto py-8 pb-16 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-muted-foreground leading-relaxed mb-8">
            {t('marketing:privacyPolicyContent.intro')}
          </p>
