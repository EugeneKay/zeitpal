...
async function TermsOfServicePage() {
  ...
  const sections = t('marketing:termsOfServiceContent.sections', {
    returnObjects: true,
  }) as Array<{ title: string; content: string }>;

  const lastUpdated = t('marketing:termsOfServiceContent.lastUpdated', {
    date: '01.01.2025',
  });
      ...
      <div className="container mx-auto py-8 pb-16 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-muted-foreground leading-relaxed mb-8">
            {t('marketing:termsOfServiceContent.intro')}
          </p>
