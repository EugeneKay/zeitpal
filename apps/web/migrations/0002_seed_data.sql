...
INSERT OR IGNORE INTO leave_types (id, organization_id, code, name_en, name_de, description_en, description_de, color, icon, is_paid, requires_approval, requires_document, document_required_after_days, has_allowance, default_days_per_year, allow_negative, allow_half_days, allow_carryover, max_carryover_days, sort_order, is_active) VALUES
...
INSERT OR IGNORE INTO public_holidays (id, bundesland, date, name_en, name_de, type, is_recurring) VALUES
...
INSERT OR IGNORE INTO public_holidays (id, bundesland, date, name_en, name_de, type) VALUES
-- 2024
